        ...
        <ul class="sidebar-menu">
            ...
            <li>
                <a href="<?php echo site_url('supplier') ?>">
                   <i class="fa fa-user"></i> <span>Suplier</span> <i class="fa fa-angle-left pull-right"></i>
                </a>
            </li>
            ...
            <li>
                <a href="<?php echo site_url('profil') ?>">
                   <i class="fa fa-book"></i> <span>Pembelian</span> <i class="fa fa-angle-left pull-right"></i>
                </a>
            </li>
