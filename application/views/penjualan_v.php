...
<section class="content-header">
    <h1>
        Halaman Penjualan
        <small>Setting Penjualan</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-book"></i> Penjualan</a></li>
...
<div class="content-wrapper">
    ...
    <section class="content">
    	<button class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-plus"></i>Tambah Data Penjualan</button>
    	<table class="table">
    		<tr>
    			<th>No</th>
    		...
    		<tr>
    			<td><?php echo $no++ ?></td>
    			<td><?php echo $penjualan->kd_penjualan ?></td>
    			<td><?php echo $penjualan ->nm_barang?></td>
